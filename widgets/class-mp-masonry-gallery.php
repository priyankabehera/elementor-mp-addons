...
namespace ElementorMPAddons\MasonryGallery;
 ...
 * @since 1.0.0
 */
class MP_Masonry_Gallery extends Widget_Base {
	/**
	 * Class constructor.
	 *
	...
	public function __construct( $data = array(), $args = null ) {
		...
		wp_register_style( 'mp-masonry-gallery', plugins_url( '/assets/css/mp-masonry-gallery.css', ELEMENTOR_MP_ADDONS ), array(), '1.0.0' );
	}
	...
	public function get_title() {
		return __( 'MP Masonry Gallery', 'elementor-mp-addons' );
	}
	...
	public function get_style_depends() {
		return array( 'mp-masonry-gallery' );
	}
