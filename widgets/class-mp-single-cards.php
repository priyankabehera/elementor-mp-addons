...
namespace ElementorMPAddons\Widgets;
 ...
 * @since 1.0.0
 */
class MP_Single_Card extends Widget_Base {
	/**
	 * Class constructor.
	 *
	...
	public function __construct( $data = array(), $args = null ) {
		...
		wp_register_style( 'mp-single-card', plugins_url( '/assets/css/mp-single-card.css', ELEMENTOR_MP_ADDONS ), array(), '1.0.0' );
	}
	...
	public function get_title() {
		return __( 'MP Single Card', 'elementor-mp-addons' );
	}
