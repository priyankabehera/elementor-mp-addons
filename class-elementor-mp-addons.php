...
/**
 * This is the main class and cannot be extended.
 */
final class Elementor_MP_Addons {
	...
	public function i18n() {
		load_plugin_textdomain( 'elementor-mp-addons' );
	}
	...
	public function admin_notice_missing_main_plugin() {
		deactivate_plugins( plugin_basename( ELEMENTOR_MP_ADDONS ) );
